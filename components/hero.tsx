    ...
    <div className="flex flex-col gap-8 items-center py-[10vh] md:py-[20vh]">
      <div className="!leading-tight mx-auto text-center">
        <div className="flex flex-col gap-2 p">
          <h1 className='text-4xl lg:text-5xl'>The fastest way to ACE your classes{" "}</h1>
          <h1 className="text-2xl lg:text-3xl text-green-500">Take the stress away from your studying</h1>
        </div>
      </div>
      <button className={`
