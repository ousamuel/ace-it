...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "p-2 flex flex-col space-y-1.5 text-center sm:text-left",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn("px-2 flex sm:flex-row justify-end gap-2", className)}
    {...props}
  />
);
